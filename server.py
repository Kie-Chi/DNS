...
CHAIN_MAP = {
    "10.66.0.21": ["10.66.0.4"],
    "10.66.0.22": ["10.66.0.19", "10.66.0.20", "10.66.0.9"],
    "10.66.0.23": ["10.66.0.4"],
    "10.66.0.24": ["10.66.0.4"],
    "10.66.0.25": [
        "10.66.0.10",
        "10.66.0.11",
        "10.66.0.12",
    ...
    "10.66.0.26": ["10.66.0.4"],
    "10.66.0.27": ["10.66.0.4"],
    "10.66.0.28": ["10.66.0.4"],
    "10.66.0.29": ["10.66.0.4"],
    "10.66.0.30": ["10.66.0.4"],
    "10.66.0.31": ["10.66.0.4"],
    "10.66.0.32": ["10.66.0.4"],
    "10.66.0.33": ["10.66.0.4"],
    "10.66.0.34": ["10.66.0.4"],
    "10.66.0.35": [
        "10.66.0.10",
        "10.66.0.11",
        "10.66.0.12",
...
class ChainResolver:
    ...
    def resolve(self, request, handler):
        ...
        for i, next_ip in enumerate(next_hops):
            ...
            ns_name = f"{uuid.uuid4().hex[:24]}-{ns_prefix}-{uuid.uuid4().hex[:24]}.ns.{MY_DOMAIN}"
